...
const checkStatus = () => {
    ...
    //to check winner
    if(tic0 && tic0 === tic1 && tic0 === tic2 ){ //tic0 is declared cos its must not be undefined
       winnerMode(tic0);
       //color for winner
...
const handleDivsClick = (r) => { //div click
...
for(const Div of Divs){  //looking at each div
